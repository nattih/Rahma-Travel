...
namespace ElegantAddons\Includes\Templates\Types;
...
if ( ! class_exists( 'Premium_Structure_Section' ) ) {
	...
	class Premium_Structure_Section extends Premium_Structure_Base {
		...
		public function get_single_label() {
			return __( 'Section', 'elegant-addons-for-elementor' );
		}

		public function get_plural_label() {
			return __( 'Sections', 'elegant-addons-for-elementor' );
		}
		...
		public function get_document_type() {
			return array(
				...
				'file'  => ELEGANT_ADDONS_PATH . 'includes/templates/documents/section.php',
			);
		}
