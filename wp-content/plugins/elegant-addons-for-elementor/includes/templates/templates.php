...
namespace ElegantAddons\Includes\Templates;
    ...
    class Premium_Templates {
        ...
        */
        private function load_files() {
            ...
            require ELEGANT_ADDONS_PATH . 'includes/templates/classes/config.php';

            require ELEGANT_ADDONS_PATH . 'includes/templates/classes/assets.php';

            require ELEGANT_ADDONS_PATH . 'includes/templates/classes/manager.php';

            require ELEGANT_ADDONS_PATH . 'includes/templates/types/manager.php';

            require ELEGANT_ADDONS_PATH . 'includes/templates/classes/api.php';
