        ...
        */
        ...
        public function editor_styles() {
            ...
            wp_enqueue_style(
                ...
                ELEGANT_ADDONS_URL . 'assets/editor/templates/css/editor.css',
                array(),
        ...
        public function enqueue_preview_styles() {
            ...
            wp_enqueue_style(
                'pa-preview',
                ELEGANT_ADDONS_URL . 'assets/editor/templates/css/preview.css',
                array(),
                ELEGANT_ADDONS_VERSION,
                'all'
            );
        ...
        public function editor_scripts() {
            ...
            wp_enqueue_script(
				...
				ELEGANT_ADDONS_URL . 'assets/editor/templates/js/editor.js',
				array(
                    'jquery',
                    'underscore',
                    'backbone-marionette'
        ...
        public function load_footer_scripts() {
            ...
            $scripts = glob( ELEGANT_ADDONS_PATH . 'includes/templates/scripts/*.php' );
