...
if ( ! class_exists( 'Premium_Templates_Manager' ) ) {
	...
	class Premium_Templates_Manager {
		...
		public function register_sources() {
			...
			require ELEGANT_ADDONS_PATH . 'includes/templates/sources/base.php';
			...
			foreach ( $sources as $key => $class ) {
				...
				require ELEGANT_ADDONS_PATH . 'includes/templates/sources/' . $key . '.php';
		...
		public function get_templates() {
			...
			$all_cats = array(
				array(
					'slug' => '',
					'title' => __( 'All', 'elegant-addons-for-elementor' ),
				)
			);
