...
namespace ElegantAddons\Compatibility\WPML\Widgets;
...
class Maps extends WPML_Elementor_Module_With_Items {
	...
	protected function get_title( $field ) {
        ...
        if ( 'map_latitude' === $field ) {
			return __( 'Maps: Marker Latitude', 'elegant-addons-for-elementor' );
		}
        if ( 'map_longitude' === $field ) {
			return __( 'Maps: Marker Longitude', 'elegant-addons-for-elementor' );
		}
        if ( 'pin_title' === $field ) {
			return __( 'Maps: Marker Title', 'elegant-addons-for-elementor' );
		}
        if ( 'pin_desc' === $field ) {
			return __( 'Maps: Marker Description', 'elegant-addons-for-elementor' );
		}
