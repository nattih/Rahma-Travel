	...
	PremiumEditor = {
		...
		initPremTempsButton: function () {
			...
			var $addNewSection = window.elementor.$previewContents.find('.elementor-add-new-section'),
				addPremiumTemplate = "<div class='elementor-add-section-area-button pa-add-section-btn elementor-elegant-icon' title='Add Elegant Template'><i class='fas fa-bell'></i></div>",
				$addPremiumTemplate;
