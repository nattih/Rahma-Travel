 ...
 * @since 1.0.0
 */
class Eae_Divider extends Widget_Base {
    ...
    public function get_title() {
        return __( 'EAE Divider', 'elegant-addons-for-elementor' );
    }
    ...
    protected function _register_controls() {
        ct_divider_control_content( $this );
    }
