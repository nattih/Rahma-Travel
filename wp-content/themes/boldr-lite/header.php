...
<body <?php body_class(); ?>>
	...
	<div id="main-wrap">
				...
				<div id="logo">
					<a href="<?php echo esc_url( home_url() ); ?>" title='<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>' rel='home'>
						...
						if ( get_theme_mod( 'boldr_logo' ) ) :
							...
							<img src="<?php echo esc_url( get_theme_mod( 'boldr_logo' ) ); ?>" alt="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>">
							<?php
						else :
							?>
							<h1 class="site-title" style="display:block"><?php bloginfo( 'name' ); ?></h1>
							<?php
						endif;
						?>
					</a>
		...
		<div id="navbar" class="container">
			...
			<div id="nav-search"><?php get_search_form(); ?></div>
		</div>
		<?php
