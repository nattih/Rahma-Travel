...
define( 'APEX_BUSINESS_MULTISELECT_VERSION', '1.0.0' );
 ...
 * @access public
 */
class Apex_Business_Customizer_Select_Multiple extends WP_Customize_Control {
	/**
	...
	public function enqueue() {
		wp_enqueue_script( 'customizer-select-multiple', get_template_directory_uri() . '/inc/customizer/customizer-select-multiple/js/script-customizer-select-multiple.js', array( 'jquery', 'customize-base' ), APEX_BUSINESS_MULTISELECT_VERSION, true );
