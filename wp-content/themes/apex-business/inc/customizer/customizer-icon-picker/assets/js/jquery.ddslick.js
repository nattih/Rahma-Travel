...
(function ($) {
    ...
    ddslickCSS = '<style id="css-ddslick" type="text/css">' +
                ...
                '.dd-selected{ overflow:hidden; display:block; font-weight:bold; background: #fff;}' +
                ...
                '.dd-option-icon, .dd-selected-icon { width:36px; text-align:center; vertical-align:middle; font-size:22px;}' +
