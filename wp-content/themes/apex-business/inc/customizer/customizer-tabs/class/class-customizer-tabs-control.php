...
define( 'APEX_BUSINESS_TABS_VERSION', '1.0.0' );
 ...
 * @access public
 */
class Apex_Business_Customizer_Tabs_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_enqueue_script( 'tabs-control-script', get_template_directory_uri() . '/inc/customizer/customizer-tabs/js/script.js', array( 'jquery' ), APEX_BUSINESS_TABS_VERSION, true );
		wp_enqueue_style( 'tabs-control-style', get_template_directory_uri() . '/inc/customizer/customizer-tabs/css/style.css', null, APEX_BUSINESS_TABS_VERSION );
	...
	public function partials_helper_script_enqueue() {
		wp_enqueue_script( 'tabs-addon-script', get_template_directory_uri() . '/inc/customizer/customizer-tabs/js/customizer-addon-script.js', array( 'jquery' ), APEX_BUSINESS_TABS_VERSION, true );
	}
