...
data.choices.labels = _.defaults( data.choices.labels, {
	select: '<?php esc_html_e( 'Select image', 'resoto' ); ?>',
	change: '<?php esc_html_e( 'Change image', 'resoto' ); ?>',
	'default': '<?php esc_html_e( 'Default', 'resoto' ); ?>',
	remove: '<?php esc_html_e( 'Remove', 'resoto' ); ?>',
	placeholder: '<?php esc_html_e( 'No image selected', 'resoto' ); ?>',
	frame_title: '<?php esc_html_e( 'Select image', 'resoto' ); ?>',
	frame_button: '<?php esc_html_e( 'Choose image', 'resoto' ); ?>',
} );
#>
