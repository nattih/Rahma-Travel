...
class Kirki_Field_Image extends Kirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args(
			$this->button_labels,
			array(
				'select'       => esc_html__( 'Select image', 'resoto' ),
				'change'       => esc_html__( 'Change image', 'resoto' ),
				'default'      => esc_html__( 'Default', 'resoto' ),
				'remove'       => esc_html__( 'Remove', 'resoto' ),
				'placeholder'  => esc_html__( 'No image selected', 'resoto' ),
				'frame_title'  => esc_html__( 'Select image', 'resoto' ),
				'frame_button' => esc_html__( 'Choose image', 'resoto' ),
			)
		);
	}
