...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_html__( 'Ultra-Light 100', 'resoto' ),
			'100light'  => esc_html__( 'Ultra-Light 100', 'resoto' ),
			'100italic' => esc_html__( 'Ultra-Light 100 Italic', 'resoto' ),
			'200'       => esc_html__( 'Light 200', 'resoto' ),
			'200italic' => esc_html__( 'Light 200 Italic', 'resoto' ),
			'300'       => esc_html__( 'Book 300', 'resoto' ),
			'300italic' => esc_html__( 'Book 300 Italic', 'resoto' ),
			'400'       => esc_html__( 'Normal 400', 'resoto' ),
			'regular'   => esc_html__( 'Normal 400', 'resoto' ),
			'italic'    => esc_html__( 'Normal 400 Italic', 'resoto' ),
			'500'       => esc_html__( 'Medium 500', 'resoto' ),
			'500italic' => esc_html__( 'Medium 500 Italic', 'resoto' ),
			'600'       => esc_html__( 'Semi-Bold 600', 'resoto' ),
			'600bold'   => esc_html__( 'Semi-Bold 600', 'resoto' ),
			'600italic' => esc_html__( 'Semi-Bold 600 Italic', 'resoto' ),
			'700'       => esc_html__( 'Bold 700', 'resoto' ),
			'700italic' => esc_html__( 'Bold 700 Italic', 'resoto' ),
			'800'       => esc_html__( 'Extra-Bold 800', 'resoto' ),
			'800bold'   => esc_html__( 'Extra-Bold 800', 'resoto' ),
			'800italic' => esc_html__( 'Extra-Bold 800 Italic', 'resoto' ),
			'900'       => esc_html__( 'Ultra-Bold 900', 'resoto' ),
			'900bold'   => esc_html__( 'Ultra-Bold 900', 'resoto' ),
			'900italic' => esc_html__( 'Ultra-Bold 900 Italic', 'resoto' ),
		);
	}
